...
urlpatterns = [
    ...
    re_path("^detail_announcement/(?P<announcement_id>\d+)/$",
            detail_announcement, name="detail_announcement"),
    re_path("^add_announcement/$", add_announcement, name="add_announcement"),
    re_path("^edit_announcement/(?P<announcement_id>\d+)/$", edit_announcement, name="edit_announcement"),
    re_path("^del_announcement/(?P<announcement_id>\d+)/$", del_announcement, name="del_announcement"),
